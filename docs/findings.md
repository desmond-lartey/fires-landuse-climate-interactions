...
- **Northern Savanna parks burn hardest and most predictably.** Mole,
  Comoé, and W (Benin) show the highest burned-area proportions, with
  December averages reaching 57–61% of park area.
- **Dry-season rainfall is the dominant climatic control.** Burned area
  rises as precipitation falls across fire-prone parks (pooled slope
  −371.08 km²/mm, p < 0.001, R² = 0.04); Gashaka-Gumti is individually
  significant (p = 0.014).
- **Fire exposure declines from interior to edge**, most strongly in
  Northern Savanna; Southern Forest shows almost no buffer-distance effect
  because fire is ecologically constrained regardless of distance.
- **Ecological zone governs fire frequency more than land-cover class
...
## Frequency by protected area

Burning concentrates in the early-to-mid dry season, October through
January, but the extent differs sharply by park.

| Protected area | Zone | Peak month | Peak burned (% of park area) |
|---|---|---|---|
| Mole | Northern Savanna | December | 57.4% |
| Parc national de la Comoé | Northern Savanna | December | 51.2% |
| Kogyae | Southern Transition | January | 42.0% |
| Parc National du W | Northern Savanna | November | 39.9% |
| Parc National de Pô dit Kaboré Tambi | Northern Savanna | November | 23.4% |
| W (Benin) | Northern Savanna | December | 22.5% |
| Kainji Lake | Northern Savanna | December | 18.6% |
| Old Oyo | Southern Transition | January | 14.0% |
| Kyabobo | Southern Transition | January | 10.4% |
| Forêt Classée et Réserve Totale de faune de Bontioli | Northern Forest | October | 6.6% |
| Gashaka-Gumti | Southern Transition | December | 5.0% |
...
2019). Wet-season burning is negligible almost everywhere, with occasional
early-ignition exceptions at a handful of savanna parks.

## Buffer and land-cover gradient

Annual burned area declines with increasing distance from park boundaries,
an effect strongest in Northern Savanna, where fire frequency peaks within
5–10 km of the interior and then declines toward 20 km. Parks and years
...
Fires outside park boundaries ignite earlier and burn more extensively
...
Forest-dominated or moist-transition parks (Bia, Bontioli) show little
distinction between inside and outside, since fire spread is ecologically
constrained regardless of boundary position.
